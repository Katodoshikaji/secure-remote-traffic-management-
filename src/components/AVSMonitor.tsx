...
const AVSMonitor: React.FC = () => {
  ...
  const cameraFeeds = [
    'https://images.unsplash.com/photo-1615328389014-71f4215a99cc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=80',
